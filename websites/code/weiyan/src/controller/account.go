...
func sendWelcomeMail(email []string) {
	content := `Welcome to weiyanweiyu.<br><br>
欢迎您，成功注册成为 weiyanweiyu 会员<br><br>
前往 <a href="http://pingliwang.com:8080">weiyanweiyu</a><br>
<div style="text-align:right;">&copy;2013 weiyanweiyu</div>`
	service.SendMail("weiyanweiyu 注册成功通知", content, email)
}
...
如果您有任何疑问，可以回复这封邮件向我们提问。谢谢！<br/><br/>`
	...
	service.SendMail("重设密码 ", content, []string{email})
}
